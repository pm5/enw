...
/**
 * @file
 * Contains theme override functions and process & preprocess functions for eee-theme
 */

// Auto-rebuild the theme registry during theme development.
if (theme_get_setting('eee-theme_clear_registry')) {
  // Rebuild .info data.
 ...
 */
function eee-theme_html_head_alter(&$head_elements) {
 ...
 */
function eee-theme_preprocess_search_block_form(&$vars) {
 ...
 */
function eee-theme_preprocess(&$vars, $hook) {
  $vars['eee-theme_path'] = base_path() . path_to_theme();
}

/**
 * Implements template_preprocess_html().
 */
function eee-theme_preprocess_html(&$vars) {
  
  $vars['doctype'] = _eee-theme_doctype();
  $vars['rdf'] = _eee-theme_rdf($vars);
  ...
  if (!$vars['is_front']) {
    ...
    if (isset($page_name)) {
      $vars['classes_array'][] = eee-theme_id_safe('page-' . $page_name);
    }

    $vars['classes_array'][] = eee-theme_id_safe('section-' . $section);
 ...
 */
function eee-theme_preprocess_page(&$vars) {
 ...
 */
function eee-theme_preprocess_maintenance_page(&$vars) {
  ...
  drupal_add_css(drupal_get_path('theme', 'eee-theme') . '/css/maintenance-page.css');
}
 ...
 */
function eee-theme_preprocess_node(&$vars) {
  // Striping class
 ...
 */
function eee-theme_preprocess_block(&$vars, $hook) {
 ...
 */
function eee-theme_menu_tree($vars) {
 ...
 */
function eee-theme_field__taxonomy_term_reference($vars) {
  $output = '';
 ...
 */
function eee-theme_breadcrumb($vars) {
  
  $breadcrumb = isset($vars['breadcrumb']) ? $vars['breadcrumb'] : array();

// Determine if we are to display the breadcrumb.
  $show_breadcrumb = theme_get_setting('eee-theme_breadcrumb_display');
  if ($show_breadcrumb == 'yes') {
  
	  if (theme_get_setting('eee-theme_breadcrumb_hideonlyfront')) {
		$condition = count($breadcrumb) > 1;
	  } else {
		$condition = !empty($breadcrumb);
	  }
	  
	  if(theme_get_setting('eee-theme_breadcrumb_showtitle')) {
	  ...
	  $separator = theme_get_setting('eee-theme_breadcrumb_separator');
 ...
 * @return bool
 */
function eee-theme_tabs_float() {
  $float = (bool) theme_get_setting('eee-theme_tabs_float');
  $float_node = (bool) theme_get_setting('eee-theme_tabs_node');
...
function eee-theme_id_safe($string) {
  // Strip accents
 ...
 * @ingroup themeable
 */
function eee-theme_menu_link(array $vars) {
  ...
  $element['#attributes']['class'][] = eee-theme_id_safe($element['#title']);
 ...
 */
function eee-theme_preprocess_menu_local_task(&$vars) {
 ...
 */
function eee-theme_menu_local_tasks(&$vars) {
  $output = '';
