...
/**
 * @file
 * Contains theme override functions and process & preprocess functions for enwmobile
 */

// Auto-rebuild the theme registry during theme development.
if (theme_get_setting('enwmobile_clear_registry')) {
  // Rebuild .info data.
 ...
 */
function enwmobile_html_head_alter(&$head_elements) {
 ...
 */
function enwmobile_preprocess_search_block_form(&$vars) {
 ...
 */
function enwmobile_preprocess(&$vars, $hook) {
  $vars['enwmobile_path'] = base_path() . path_to_theme();
}

/**
 * Implements template_preprocess_html().
 */
function enwmobile_preprocess_html(&$vars) {

  $vars['doctype'] = _enwmobile_doctype();
  $vars['rdf'] = _enwmobile_rdf($vars);
  ...
  if (!$vars['is_front']) {
    ...
    if (isset($page_name)) {
      $vars['classes_array'][] = enwmobile_id_safe('page-' . $page_name);
    }

    $vars['classes_array'][] = enwmobile_id_safe('section-' . $section);
 ...
 */
function enwmobile_preprocess_page(&$vars) {
 ...
 */
function enwmobile_preprocess_maintenance_page(&$vars) {
  ...
  drupal_add_css(drupal_get_path('theme', 'enwmobile') . '/css/maintenance-page.css');
}
 ...
 */
function enwmobile_preprocess_node(&$vars) {
  // Striping class
 ...
 */
function enwmobile_preprocess_block(&$vars, $hook) {
 ...
 */
function enwmobile_menu_tree($vars) {
 ...
 */
function enwmobile_field__taxonomy_term_reference($vars) {
  $output = '';
 ...
 */
function enwmobile_breadcrumb($vars) {

  $breadcrumb = isset($vars['breadcrumb']) ? $vars['breadcrumb'] : array();

// Determine if we are to display the breadcrumb.
  $show_breadcrumb = theme_get_setting('enwmobile_breadcrumb_display');
  if ($show_breadcrumb == 'yes') {

	  if (theme_get_setting('enwmobile_breadcrumb_hideonlyfront')) {
		$condition = count($breadcrumb) > 1;
	  } else {
		$condition = !empty($breadcrumb);
	  }

	  if(theme_get_setting('enwmobile_breadcrumb_showtitle')) {
	  ...
	  $separator = theme_get_setting('enwmobile_breadcrumb_separator');
 ...
 * @return bool
 */
function enwmobile_tabs_float() {
  $float = (bool) theme_get_setting('enwmobile_tabs_float');
  $float_node = (bool) theme_get_setting('enwmobile_tabs_node');
...
function enwmobile_id_safe($string) {
  // Strip accents
 ...
 * @ingroup themeable
 */
function enwmobile_menu_link(array $vars) {
  ...
  $element['#attributes']['class'][] = enwmobile_id_safe($element['#title']);
 ...
 */
function enwmobile_preprocess_menu_local_task(&$vars) {
 ...
 */
function enwmobile_menu_local_tasks(&$vars) {
  $output = '';
