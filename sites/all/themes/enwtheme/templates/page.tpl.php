  ...
  <div id="main-wrapper">
    ...
    <?php endif; ?>
      ...
      <div id="content" class="column" role="main">
        ...
        <?php if ($is_front): ?>
            <h2 class="front-title">LATEST TOPICS</h2>
        <?php endif; ?>
    ...
    <footer id="footer" role="contentinfo">
        <div class="footer-wrapper clearfix">
            ...
            <?php if ($is_front): ?>More <a rel="nofollow" href="http://www.templatemonster.com/category/soccer-drupal-themes/" target="_blank">Soccer Drupal Themes at TemplateMonster.com</a><?php endif; ?>
        </div><!-- /#footer-wrapper -->
    </footer><!-- /#footer -->
