...
<?php if ( !theme_get_setting( 'theme979_breadcrumb_show' ) ) :
	$breadcrumb = NULL;
endif; ?>
...
<div id="page-wrapper" class="page-wrapper">
	<div id="page" class="page">
		...
		<header id="header" class="header page-header clearfix" role="banner">
			...
			<div class="<?php if ( theme_get_setting( 'theme979_sticky_menu' ) ) { echo 'stickup '; } ?>header-section-2"> <!-- Sticky menu wrapper -->
				<div class="container-12">
					<div class="grid-12">
						<div class="col1">
							<!-- Region Menu -->
			...
			<!-- Region Header -->
			<?php if ( $page['header'] ) : 
				theme979_region_preffix ( 'header' );
					print render( $page['header'] );
				theme979_region_suffix ( 'header' );
			endif; ?>

			<!-- Region Header bottom -->
			<?php if ( $page['header_bottom'] ) : 
				theme979_region_preffix ( 'header_bottom' );
					print render( $page['header_bottom'] );
				theme979_region_suffix ( 'header_bottom' );
			endif; ?>
		</header>
		...
		<div id="main-wrapper" class="main-wrapper" role="main">
			...
			<?php if ( $page['parallax_one'] ) : 
				theme979_region_preffix ( 'parallax_one' );
					print render( $page['parallax_one'] );
				theme979_region_suffix ( 'parallax_one' );
			endif; ?>
			
			<!-- Region parallax two -->
			<?php if ( $page['parallax_two'] ) : 
				theme979_region_preffix ( 'parallax_two' );
					print render( $page['parallax_two'] );
				theme979_region_suffix ( 'parallax_two' );
			endif; ?>
			
			<!-- Region content top -->
			<?php if ( $page['content_top'] ) : 
				theme979_region_preffix ( 'content_top' );
					print render( $page['content_top'] );
				theme979_region_suffix ( 'content_top' );
			endif; ?>
			...
			<?php if ( $page['content_bottom'] ) : 
				theme979_region_preffix ( 'content_bottom' );
					print render( $page['content_bottom'] );
				theme979_region_suffix ( 'content_bottom' );
			endif; ?>
		</div>
		...
		<footer id="footer" class="footer page-footer" role="contentinfo">
			...
			<?php if ( $page['footer_top'] ) : 
				theme979_region_preffix ( 'footer_top' );
					print render( $page['footer_top'] );
				theme979_region_suffix ( 'footer_top' );
			endif; ?>
			...
			<div class="footer-wrapper clearfix">
				<div class="container-12">
					<div class="grid-12 clearfix">
						...
						<?php if ( $is_front && 0) : ?>
							More Game Portal Drupal Themes at <a rel="nofollow" href="http://www.templatemonster.com/category/game-portal-drupal-themes/" target="_blank">TemplateMonster.com</a>
						<?php endif; ?>
					</div>
				</div>
			</div>
